  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-blue-950 to-slate-950 relative overflow-hidden">
      ...
      <div className="flex h-[calc(100vh-73px)]">
        ...
        {/* Main Content */}
        <div className={`flex-1 flex ${devMode ? 'flex-row' : 'flex-col'} relative z-10`}>
          {/* Content Area */}
          <div className={`${devMode ? 'flex-1' : 'flex-1'} flex flex-col`}>
            {/* Enhanced Title */}
          ...
          {/* Code Editor Panel (visible in dev mode) */}
          {devMode && (
            <div className="w-1/2 h-full">
              <CodeEditor hasSubmittedQuery={hasSubmittedQuery} />
            </div>
          )}
        </div>
      </div>
