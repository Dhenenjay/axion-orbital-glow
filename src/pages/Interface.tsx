        ...
        <div className="flex-1 flex flex-col relative z-10">
          ...
          <div className="px-8 py-6 border-b border-slate-700/50 bg-gradient-to-r from-slate-800/30 to-slate-900/30 backdrop-blur-sm">
            ...
            <p className="text-gray-400 text-sm">
              Harness the power of real-time satellite intelligence with natural language queries
            </p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-6 flex items-center space-x-4">
              <Button className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white px-8 py-3 text-lg font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25">
